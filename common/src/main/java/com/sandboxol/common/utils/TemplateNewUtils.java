...
import com.sandboxol.common.base.app.TemplateNewActivity;
...
public class TemplateNewUtils {
    ...
    public static void startTemplate(Context context, Class objClass, String title, int leftResId, int rightResId, Bundle params) {
        context.startActivity(new Intent(context, TemplateNewActivity.class)
                .putExtra(TemplateNewActivity.NAME, objClass)
                .putExtra(TemplateNewActivity.TITLE, title)
                .putExtra(TemplateNewActivity.PARAMS, params)
                .putExtra(TemplateNewActivity.LEFT_RESOURCE_ID, leftResId)
                .putExtra(TemplateNewActivity.RIGHT_RESOURCE_ID, rightResId));
    }
    ...
    public static void startTemplate(Context context, Class objClass, String title, int leftResId, String rightText, Bundle params) {
        context.startActivity(new Intent(context, TemplateNewActivity.class)
                ...
                .putExtra(TemplateNewActivity.PARAMS, params)
                .putExtra(TemplateNewActivity.LEFT_RESOURCE_ID, leftResId)
                .putExtra(TemplateNewActivity.RIGHT_RESOURCE_ID, -1)
                .putExtra(TemplateNewActivity.RIGHT_TEXT, rightText));
    }
    ...
    public static void startTemplateForResult(Activity activity, Class objClass, String title, int leftResId, int rightResId, Bundle params, int requestCode) {
        activity.startActivityForResult(new Intent(activity, TemplateNewActivity.class)
                .putExtra(TemplateNewActivity.NAME, objClass)
                .putExtra(TemplateNewActivity.TITLE, title)
                .putExtra(TemplateNewActivity.PARAMS, params)
                .putExtra(TemplateNewActivity.LEFT_RESOURCE_ID, leftResId)
                .putExtra(TemplateNewActivity.RIGHT_RESOURCE_ID, rightResId), requestCode);
    }
    ...
    public static void startTemplateForResult(Activity activity, Class objClass, String title, int leftResId, String rightText, Bundle params, int requestCode) {
        activity.startActivityForResult(new Intent(activity, TemplateNewActivity.class)
                ...
                .putExtra(TemplateNewActivity.LEFT_RESOURCE_ID, leftResId)
                .putExtra(TemplateNewActivity.RIGHT_RESOURCE_ID, -1)
                .putExtra(TemplateNewActivity.RIGHT_TEXT, rightText), requestCode);
    }
    ...
    public static void startTemplateWithFlags(Context context, Class objClass, String title, int flags) {
        context.startActivity(new Intent(context, TemplateNewActivity.class)
                .putExtra(TemplateNewActivity.NAME, objClass)
                .putExtra(TemplateNewActivity.TITLE, title)
                .putExtra(TemplateNewActivity.LEFT_RESOURCE_ID, -1)
                .putExtra(TemplateNewActivity.RIGHT_RESOURCE_ID, -1)
                .addFlags(flags));
    }
